			...
			<form action="" method="post" enctype="multipart/form-data" name="form1">
				...
				<table width="100%" border="0" cellspacing="5" cellpadding="5">
					<tr>
						...
						<td width="66%">
							<input name="nama" type="text" id="nama" value="<?php echo (isset($_POST['nama'])) ? $_POST['nama'] : ''; ?>" size="45">
					...
					<tr>
						...
						<td>
							<input name="kota_lahir" type="text" value="<?php echo (isset($_POST['kota_lahir'])) ? $_POST['kota_lahir'] : ''; ?>" id="ttl" size="45">
					...
					<tr>
						...
						<td align="center" valign="top">:</td>
						<td>
							<input name="tanggal_lahir" type="text" value="<?php echo (isset($_POST['tanggal_lahir'])) ? $_POST['tanggal_lahir'] : ''; ?>" id="datepicker" size="45" placeholder="yyyy-mm-dd">
					...
					<tr>
						...
						<td align="center" valign="top">:</td>
						<td>
							<input name="agama" type="text" value="<?php echo (isset($_POST['agama'])) ? $_POST['agama'] : ''; ?>" id="agama" size="45">
					...
					<tr>
						...
						<td align="center" valign="top">:</td>
						<td>
							<textarea name="alamat" id="alamat" cols="40" rows="5"><?php echo (isset($_POST['alamat'])) ? $_POST['alamat'] : ''; ?></textarea>
					...
					<tr>
						...
						<td align="center" valign="top">:</td>
						<td>
							<input name="tlp" type="text" value="<?php echo (isset($_POST['tlp'])) ? $_POST['tlp'] : ''; ?>" id="tlp" size="45">
					...
					<tr>
						...
						<td align="center" valign="top">:</td>
						<td>
							<input name="sekolah" type="text" value="<?php echo (isset($_POST['sekolah'])) ? $_POST['sekolah'] : ''; ?>" id="sekolah" size="45">
					...
					<tr>
						...
						<td align="center" valign="top">:</td>
						<td>
							<input name="hobi" type="text" value="<?php echo (isset($_POST['hobi'])) ? $_POST['hobi'] : ''; ?>" id="hobi" size="45">
						</td>
					</tr>
					<tr>
						...
						<td align="center" valign="top">:</td>
						<td>
							<input name="cita" type="text" value="<?php echo (isset($_POST['cita'])) ? $_POST['cita'] : ''; ?>" id="cita" size="45">
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td align="center" valign="top">:</td>
						<td>
							<input name="ayah" type="text" value="<?php echo (isset($_POST['ayah'])) ? $_POST['ayah'] : ''; ?>" id="ayah" size="45">
					...
					<tr>
						...
						<td align="center" valign="top">:</td>
						<td>
							<input name="ibu" type="text" value="<?php echo (isset($_POST['ibu'])) ? $_POST['ibu'] : ''; ?>" id="ibu" size="45">
					...
					<tr>
						...
						<td align="center" valign="top">:</td>
						<td>
							<input name="pekerjaanayah" type="text" value="<?php echo (isset($_POST['pekerjaanayah'])) ? $_POST['pekerjaanayah'] : ''; ?>" id="pekerjaanayah" size="45">
						</td>
					</tr>
					<tr>
						<td valign="top">b. Ibu</td>
						<td align="center" valign="top">:</td>
						<td>
							<input name="pekerjaanibu" type="text" value="<?php echo (isset($_POST['pekerjaanibu'])) ? $_POST['pekerjaanibu'] : ''; ?>" id="pekerjaanibu" value="" size="45">
						</td>
					</tr>
					<tr>
						...
						<td align="center" valign="top">:</td>
						<td>
							<input name="email" type="text" value="<?php echo (isset($_POST['email'])) ? $_POST['email'] : ''; ?>" id="email" size="45">
